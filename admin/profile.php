                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" value="<?php echo $row->MName; ?>"
                                            class="form-control">
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" name="email" id="emailid"
                                            value="<?php echo $row->MEmail; ?>" readonly required="required">
                                    </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="contact" id="emailid"
                                            value="<?php echo $row->MPhone; ?>" required="required">
                                    </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="address" id="emailid"
                                            value="<?php echo $row->MAddress; ?>" required="required">
                                    </div>
