                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-hover table-bordered no-wrap">
                                        ...
                                        <td>
                                        <a href="view-students-acc.php?del=<?php echo $row->CMS;?>" title="Delete Record" onclick="return confirm("Do you want to delete");"><i class="icon-close" style="color:red;"></i></a></td>
                                        </tr>
                                            <?php
