        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">My Mess Off Activity</h4>
                            <div class="table-responsive">
                                <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = "SELECT * FROM mess_off WHERE cms = '$cms'";
                                            
                                            $result = mysqli_query($mysqli, $sql);
                                            $row = mysqli_num_rows($result);
                                            if($row > 0){
                                                while($row = mysqli_fetch_array($result)){
                                                    echo "<tr><td>".$row['ID']."</td><td>".$row['MSDate']."</td><td>".$row['MEDate']."</td><td>".$row['MReason']."</td></tr>";
                                                }
                                            }
                                        ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Student's Mess Off Form</h4>
